...
class BillReportComponent extends Component {
    ...
    componentDidMount() {
        this.props.getListBillReport(this.state.fromDate.toISOString().split('T')[0], this.state.toDate.toISOString().split('T')[0], this.state.branch);
                ...
                <Card>
                    <CardBody>
                        <div className='l_header'>
                            <Row>
                                <Col sm="4">
                                    <h4 className="mb-0" style={{ display: "inline" }}><strong>Thống kê doanh thu bán hàng</strong></h4>{' '}
                                    <Form inline>
                                        <DatePicker
                        ...
                        <Container fluid>
                            <ReactTable
                                data={this.props.listBillReport}
                                minRows={5}
                                columns={[
                                    {
                                        Header: '#',
